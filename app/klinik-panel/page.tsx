    ...
    <main style={{minHeight:"100vh",background:"#f9fafb",fontFamily:"sans-serif"}}>
      <style>{`
        @media (min-width:769px){
          ...
          .panel-icerik{margin-left:0;}
          .mobil-header{display:none!important;}
        }
        @media (max-width:768px){
          .panel-sidebar{display:none!important;}
          .panel-sidebar.acik{display:flex!important;position:fixed;inset:0;z-index:1000;}
          .panel-icerik{padding:16px!important;}
          .grid-4{grid-template-columns:1fr 1fr!important;}
          .grid-3{grid-template-columns:1fr 1fr!important;}
          .grid-2{grid-template-columns:1fr!important;}
          .scroll-table{overflow-x:auto;}
          .mobil-header{display:flex!important;}
        }
      `}</style>
      ...
      {/* Sidebar */}
      <aside className={`panel-sidebar${sidebarAcik?" acik":""}`} style={{width:"230px",background:"#12103a",flexDirection:"column",padding:"24px 0",flexShrink:0,height:"100vh",overflowY:"auto",position:"fixed",left:0,top:0,zIndex:1000}}>
        <div style={{padding:"0 20px 16px",borderBottom:"1px solid #1e1b4b",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          ...
          <button onClick={()=>setSidebarAcik(false)} className="mobil-header" style={{background:"none",border:"none",color:"#7F77DD",fontSize:"20px",cursor:"pointer",display:"none"}}>×</button>
        </div>
      ...
      {/* Mobil üst bar */}
      <div className="mobil-header" style={{display:"none",position:"sticky",top:0,zIndex:100,background:"#12103a",padding:"12px 16px",alignItems:"center",justifyContent:"space-between"}}>
      ...
      {/* İçerik */}
      <div className="panel-icerik" style={{marginLeft:"230px",padding:"28px",minHeight:"100vh"}}>
        {mesaj&&(<div style={{background:mesaj.includes("Hata")?"#fff0f0":"#f0fff4",border:`1px solid ${mesaj.includes("Hata")?"#fcc":"#9f9"}`,borderRadius:"8px",padding:"10px 16px",marginBottom:"16px",fontSize:"13px",color:mesaj.includes("Hata")?"#c00":"#0a7a3a",position:"sticky",top:"60px",zIndex:50}}>{mesaj}</div>)}
          ...
          <>
            ...
            {menu==="onceSonra"&&(<div>
              ...
              <div style={kart}>
                ...
                <div className="grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"12px",marginBottom:"10px"}}>
                  ...
                  return(<div key={t.id} style={{background:"#fff",border:"1px solid #EEEDFE",borderRadius:"12px",overflow:"hidden"}}>
                    ...
                    {acik&&kullanici?.onaylandi&&(<div style={{borderTop:"1px solid #EEEDFE",padding:"16px",background:"#fafafa"}}>
                      ...
                      <div style={{background:"#fff",borderRadius:"8px",padding:"10px 12px",border:"1px solid #EEEDFE",marginBottom:"8px"}}>
                        ...
                        {form.otel_dahil&&(<div className="grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px"}}><input type="text" placeholder={m.otelAdi} value={form.otel_aciklama} onChange={e=>setTeklifForm(t.id,{otel_aciklama:e.target.value})} style={inp}/><input type="number" placeholder={m.otelFiyat} value={form.otel_fiyat} onChange={e=>setTeklifForm(t.id,{otel_fiyat:e.target.value})} style={inp}/></div>)}
                      </div>
