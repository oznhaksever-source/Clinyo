    ...
    <main style={{ minHeight: "100vh", background: "#f9fafb", fontFamily: "sans-serif" }}>
      ...
      <nav style={{ background: "#12103a", padding: "16px 32px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
          ...
          <a href="/tedaviler" style={{ color: "#fff", fontSize: "13px", textDecoration: "none", borderBottom: "2px solid #534AB7", paddingBottom: "2px" }}>Tedaviler</a>
      ...
      <footer style={{ background: "#12103a", padding: "24px 32px", display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "32px" }}>
        ...
        <div style={{ fontSize: "12px", color: "#6b6fa8" }}>2024 Medoqa. Tum haklari saklidir.</div>
      </footer>
