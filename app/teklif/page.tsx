...
const ANA_KATEGORILER = [
  {id:"dis",emoji:"🦷",tr:"Diş Tedavisi",en:"Dental Treatment",de:"Zahnbehandlung",renk:"#0891B2",altlar:[{tr:"İmplant",en:"Implant",de:"Implantat"},{tr:"Zirkonyum Kaplama",en:"Zirconia Crown",de:"Zirkonkrone"},{tr:"Lamine Veneer",en:"Laminate Veneer",de:"Laminat Veneer"},{tr:"Diş Beyazlatma",en:"Teeth Whitening",de:"Zahnaufhellung"},{tr:"Kanal Tedavisi",en:"Root Canal",de:"Wurzelkanal"},{tr:"Diş Çekimi",en:"Tooth Extraction",de:"Zahnextraktion"},{tr:"Ortodonti",en:"Orthodontics",de:"Kieferorthopädie"},{tr:"All-on-4 / All-on-6",en:"All-on-4 / All-on-6",de:"All-on-4 / All-on-6"},{tr:"Gülüş Tasarımı",en:"Smile Design",de:"Lächeldesign"},{tr:"Diş Taşı Temizliği",en:"Teeth Cleaning",de:"Zahnsteinentfernung"}]},
  {id:"sac",emoji:"💇",tr:"Saç Ekimi",en:"Hair Transplant",de:"Haartransplantation",renk:"#7C3AED",altlar:[{tr:"FUE Saç Ekimi",en:"FUE Hair Transplant",de:"FUE Haartransplantation"},{tr:"DHI Saç Ekimi",en:"DHI Hair Transplant",de:"DHI Haartransplantation"},{tr:"Safir FUE",en:"Sapphire FUE",de:"Saphir FUE"},{tr:"Sakal Ekimi",en:"Beard Transplant",de:"Barttransplantation"},{tr:"Kaş Ekimi",en:"Eyebrow Transplant",de:"Augenbrauentransplantation"},{tr:"PRP Tedavisi",en:"PRP Treatment",de:"PRP Behandlung"}]},
  {id:"goz",emoji:"👁️",tr:"Göz Ameliyatı",en:"Eye Surgery",de:"Augenoperation",renk:"#059669",altlar:[{tr:"Lasik",en:"Lasik",de:"Lasik"},{tr:"Lasek",en:"Lasek",de:"Lasek"},{tr:"PRK",en:"PRK",de:"PRK"},{tr:"Smile Pro",en:"Smile Pro",de:"Smile Pro"},{tr:"Göz İçi Lens (ICL)",en:"Intraocular Lens (ICL)",de:"Intraokulare Linse (ICL)"},{tr:"Katarakt Ameliyatı",en:"Cataract Surgery",de:"Kataraktoperation"}]},
  {id:"plastik",emoji:"💉",tr:"Plastik Cerrahi",en:"Plastic Surgery",de:"Plastische Chirurgie",renk:"#DC2626",altlar:[{tr:"Burun Estetiği",en:"Rhinoplasty",de:"Rhinoplastik"},{tr:"Yüz Germe",en:"Face Lift",de:"Gesichtslifting"},{tr:"Göz Kapağı Estetiği",en:"Eyelid Surgery",de:"Lidchirurgie"},{tr:"Meme Büyütme",en:"Breast Augmentation",de:"Brustvergrößerung"},{tr:"Meme Küçültme",en:"Breast Reduction",de:"Brustverkleinerung"},{tr:"Karın Germe",en:"Tummy Tuck",de:"Bauchdeckenstraffung"},{tr:"Liposuction",en:"Liposuction",de:"Liposuktion"},{tr:"Botoks",en:"Botox",de:"Botox"},{tr:"Dolgu (Filler)",en:"Filler",de:"Filler"}]},
  {id:"ortopedi",emoji:"🦴",tr:"Ortopedi",en:"Orthopedics",de:"Orthopädie",renk:"#4F46E5",altlar:[{tr:"Diz Protezi",en:"Knee Prosthesis",de:"Knieprothese"},{tr:"Kalça Protezi",en:"Hip Prosthesis",de:"Hüftprothese"},{tr:"Omurga Cerrahisi",en:"Spine Surgery",de:"Wirbelsäulenchirurgie"},{tr:"Spor Yaralanmaları",en:"Sports Injuries",de:"Sportverletzungen"},{tr:"Artroskopi",en:"Arthroscopy",de:"Arthroskopie"}]},
  {id:"checkup",emoji:"🏥",tr:"Check-Up",en:"Check-Up",de:"Check-Up",renk:"#D97706",altlar:[{tr:"Temel Check-Up",en:"Basic Check-Up",de:"Basis Check-Up"},{tr:"Kapsamlı Check-Up",en:"Comprehensive Check-Up",de:"Umfassender Check-Up"},{tr:"Kardiyoloji Check-Up",en:"Cardiology Check-Up",de:"Kardiologie Check-Up"},{tr:"Onkoloji Taraması",en:"Oncology Screening",de:"Onkologie-Screening"},{tr:"Dermatoloji",en:"Dermatology",de:"Dermatologie"}]},
  {id:"diger",emoji:"📋",tr:"Diğer",en:"Other",de:"Sonstiges",renk:"#64748b",altlar:[]},
];
...
function TeklifIcerik() {
  ...
  // Klinik ID varsa klinik bilgilerini çek
  useEffect(() => {
  ...
  const kategoriAd = (kat: typeof ANA_KATEGORILER[0]) => dil==="tr"?kat.tr:dil==="en"?kat.en:kat.de;
  const altAd = (alt: {tr:string,en:string,de:string}) => dil==="tr"?alt.tr:dil==="en"?alt.en:alt.de;
