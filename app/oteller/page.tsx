...
const tumOteller = [
  ...
  { id: "4", kisaltma: "HB", ad: "Hilton Bursa", sehir: "Bursa", ilce: "Nilüfer", yildiz: 5, puan: 4.7, yorum: 189, fiyat: 95, para: "EUR", klinikYakinligi: ["Bursa Göz Merkezi"], olanaklar: ["WiFi", "Havuz", "Spa", "Restoran"], oda: "Standart Oda" },
  { id: "5", kisaltma: "RA", ad: "Ramada Antalya", sehir: "Antalya", ilce: "Muratpaşa", yildiz: 4, puan: 4.5, yorum: 134, fiyat: 75, para: "EUR", klinikYakinligi: ["Antalya Smile"], olanaklar: ["WiFi", "Havuz", "Restoran", "Transfer"], oda: "Standart Oda" },
  { id: "6", kisaltma: "SK", ad: "Sheraton Ankara", sehir: "Ankara", ilce: "Çankaya", yildiz: 5, puan: 4.7, yorum: 267, fiyat: 110, para: "EUR", klinikYakinligi: ["Ankara Dental"], olanaklar: ["WiFi", "Havuz", "Spa", "Restoran", "Transfer"], oda: "Deluxe Oda" },
];
    ...
    <main style={{ minHeight: "100vh", background: "#f9fafb", fontFamily: "sans-serif" }}>
      ...
      <nav style={{ background: "#12103a", padding: "16px 32px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
          ...
          <a href="/oteller" style={{ color: "#fff", fontSize: "13px", textDecoration: "none", borderBottom: "2px solid #534AB7", paddingBottom: "2px" }}>Oteller</a>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                ...
                <div style={{ flex: 1, padding: "18px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }}>
                    <div>
                      ...
                      <div style={{ fontSize: "12px", color: "#534AB7" }}>📍 Yakın: {o.klinikYakinligi.join(", ")}</div>
                    </div>
            ...
            {filtreliOteller.length === 0 && (
              <div style={{ textAlign: "center", padding: "64px", background: "#fff", borderRadius: "14px", border: "1px solid #EEEDFE" }}>
                ...
                <div style={{ fontSize: "16px", fontWeight: 700, color: "#12103a", marginBottom: "8px" }}>Otel bulunamadı</div>
