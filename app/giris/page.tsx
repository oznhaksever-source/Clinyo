...
export default function Giris() {
  ...
  async function girisYap() {
    ...
    if (error) {
      ...
      setMesaj("Giris basarili! Yonlendiriliyor...");
  ...
  async function kayitOl() {
    ...
    if (error) {
      ...
      setMesaj("Kayit basarili! Lutfen emailinizi dogrulayin.");
    }
    setYukleniyor(false);
  }
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "32px" }}>
        <div style={{ background: "#fff", borderRadius: "16px", padding: "40px", width: "100%", maxWidth: "420px" }}>
          ...
          <div style={{ display: "flex", background: "#f9fafb", borderRadius: "10px", padding: "4px", marginBottom: "24px" }}>
            <button onClick={() => setMod("giris")} style={{ flex: 1, padding: "8px", border: "none", borderRadius: "8px", fontSize: "13px", cursor: "pointer", fontWeight: 500, background: mod === "giris" ? "#fff" : "transparent", color: mod === "giris" ? "#185FA5" : "#888" }}>
              Giris Yap
            </button>
            <button onClick={() => setMod("kayit")} style={{ flex: 1, padding: "8px", border: "none", borderRadius: "8px", fontSize: "13px", cursor: "pointer", fontWeight: 500, background: mod === "kayit" ? "#fff" : "transparent", color: mod === "kayit" ? "#185FA5" : "#888" }}>
              Kayit Ol
            </button>
          </div>
          ...
          {mod === "giris" ? (
            <div>
              ...
              <button onClick={girisYap} disabled={yukleniyor} style={{ width: "100%", background: "#185FA5", color: "#fff", border: "none", padding: "12px", borderRadius: "8px", fontSize: "14px", cursor: "pointer", fontWeight: 500, marginBottom: "16px", opacity: yukleniyor ? 0.7 : 1 }}>
            ...
            <div>
              ...
              <button onClick={kayitOl} disabled={yukleniyor} style={{ width: "100%", background: "#185FA5", color: "#fff", border: "none", padding: "12px", borderRadius: "8px", fontSize: "14px", cursor: "pointer", fontWeight: 500, opacity: yukleniyor ? 0.7 : 1 }}>
