...
export default function Yakinda() {
  ...
  const icerik = {
    tr: { hazirlaniyoruz: "YAKINDA", baslik: "Sağlıkta Sınır", vurgu: "Tanımayın", aciklama: "Dünyanın dört bir yanından onaylı klinikler, şeffaf fiyatlar ve güvenli ödeme sistemi. Medoqa çok yakında hizmetinizde.", bildirimBaslik: "Açılıştan haberdar olun", emailPlaceholder: "E-posta adresiniz", buton: "Beni Haberdar Et", tesekkur: "Teşekkürler! Açılışta sizi haberdar edeceğiz.", ozellikler: [{ ikon: "🔒", baslik: "Blokeli Ödeme", aciklama: "Paranız tedavi tamamlanana kadar güvende" }, { ikon: "✓", baslik: "Onaylı Klinikler", aciklama: "Sağlık Bakanlığı belgeli klinikler" }, { ikon: "⚖", baslik: "Şeffaf Fiyat", aciklama: "Gizli ücret yok, sürpriz yok" }, { ikon: "🌍", baslik: "Global Platform", aciklama: "6 dil desteği" }], sosyal: "Bizi takip edin:" },
    en: { hazirlaniyoruz: "COMING SOON", baslik: "Healthcare Without", vurgu: "Borders", aciklama: "Verified clinics from around the world, transparent prices and secure payment. Medoqa is coming very soon.", bildirimBaslik: "Get notified at launch", emailPlaceholder: "Your email address", buton: "Notify Me", tesekkur: "Thank you! We'll notify you at launch.", ozellikler: [{ ikon: "🔒", baslik: "Escrow Payment", aciklama: "Your money is safe until treatment is complete" }, { ikon: "✓", baslik: "Verified Clinics", aciklama: "Ministry of Health certified" }, { ikon: "⚖", baslik: "Transparent Pricing", aciklama: "No hidden fees" }, { ikon: "🌍", baslik: "Global Platform", aciklama: "6 language support" }], sosyal: "Follow us:" },
    de: { hazirlaniyoruz: "DEMNÄCHST", baslik: "Gesundheit ohne", vurgu: "Grenzen", aciklama: "Verifizierte Kliniken aus aller Welt. Medoqa kommt sehr bald.", bildirimBaslik: "Bei der Eröffnung benachrichtigt werden", emailPlaceholder: "Ihre E-Mail-Adresse", buton: "Benachrichtigen", tesekkur: "Danke! Wir benachrichtigen Sie.", ozellikler: [{ ikon: "🔒", baslik: "Treuhandzahlung", aciklama: "Sicher bis Behandlung abgeschlossen" }, { ikon: "✓", baslik: "Verifizierte Kliniken", aciklama: "Ministerium zertifiziert" }, { ikon: "⚖", baslik: "Transparente Preise", aciklama: "Keine versteckten Gebühren" }, { ikon: "🌍", baslik: "Globale Plattform", aciklama: "6 Sprachen" }], sosyal: "Folgen Sie uns:" },
    ar: { hazirlaniyoruz: "قريباً", baslik: "الرعاية الصحية بلا", vurgu: "حدود", aciklama: "عيادات معتمدة من جميع أنحاء العالم، أسعار شفافة ودفع آمن. Medoqa قادمة قريباً.", bildirimBaslik: "احصل على إشعار عند الإطلاق", emailPlaceholder: "بريدك الإلكتروني", buton: "أخبرني", tesekkur: "شكراً! سنخطرك عند الإطلاق.", ozellikler: [{ ikon: "🔒", baslik: "دفع ضمني", aciklama: "أموالك آمنة حتى اكتمال العلاج" }, { ikon: "✓", baslik: "عيادات معتمدة", aciklama: "موثقة من وزارة الصحة" }, { ikon: "⚖", baslik: "أسعار شفافة", aciklama: "لا رسوم خفية" }, { ikon: "🌍", baslik: "منصة عالمية", aciklama: "6 لغات" }], sosyal: "تابعنا:" },
    ru: { hazirlaniyoruz: "СКОРО", baslik: "Здравоохранение без", vurgu: "границ", aciklama: "Сертифицированные клиники, прозрачные цены и безопасная оплата. Medoqa скоро запускается.", bildirimBaslik: "Получите уведомление о запуске", emailPlaceholder: "Ваш email", buton: "Уведомить меня", tesekkur: "Спасибо! Мы уведомим вас.", ozellikler: [{ ikon: "🔒", baslik: "Эскроу-платёж", aciklama: "Деньги в безопасности до конца лечения" }, { ikon: "✓", baslik: "Проверенные клиники", aciklama: "Сертифицированы Минздравом" }, { ikon: "⚖", baslik: "Прозрачные цены", aciklama: "Нет скрытых платежей" }, { ikon: "🌍", baslik: "Глобальная платформа", aciklama: "6 языков" }], sosyal: "Подписывайтесь:" },
    fr: { hazirlaniyoruz: "BIENTÔT", baslik: "La santé sans", vurgu: "frontières", aciklama: "Cliniques vérifiées du monde entier, prix transparents et paiement sécurisé. Medoqa arrive très bientôt.", bildirimBaslik: "Être notifié au lancement", emailPlaceholder: "Votre adresse e-mail", buton: "M'avertir", tesekkur: "Merci ! Nous vous notifierons.", ozellikler: [{ ikon: "🔒", baslik: "Paiement sécurisé", aciklama: "Argent en sécurité jusqu'à la fin" }, { ikon: "✓", baslik: "Cliniques vérifiées", aciklama: "Certifiées Ministère Santé" }, { ikon: "⚖", baslik: "Prix transparents", aciklama: "Pas de frais cachés" }, { ikon: "🌍", baslik: "Plateforme mondiale", aciklama: "6 langues" }], sosyal: "Suivez-nous :" },
  };
