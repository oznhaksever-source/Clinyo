  ...
  const icerik = {
    tr: {
      ...
      sorular: [
        ...
        { soru: "Ek işlemler için ekstra ücret ödemek zorunda mıyım?", cevap: "Hayır! Klinik ek işlem önerecekse önce sizden onay almak zorundadır. Siz onaylamadan fiyata eklenemez." },
    ...
    en: {
      ...
      adimlar: [
        { foto: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=600&h=400&fit=crop", baslik: "Choose Your Treatment", aciklama: "Dental, hair transplant, eye, aesthetic or orthopedics — 500+ treatment options available.", detaylar: ["500+ treatment options", "Detailed treatment info", "Price ranges"] },
      ...
      sorular: [
        ...
        { soru: "How are clinics verified?", cevap: "All clinics submit their Ministry of Health licenses, doctor certificates and insurance documents before joining." },
    ...
    de: {
      ...
      adimlar: [
        { foto: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=600&h=400&fit=crop", baslik: "Behandlung wählen", aciklama: "Zahn, Haartransplantation, Auge, Ästhetik oder Orthopädie — 500+ Optionen verfügbar.", detaylar: ["500+ Behandlungsoptionen", "Detaillierte Informationen", "Preisspannen"] },
        { foto: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&h=400&fit=crop", baslik: "Kostenloses Angebot", aciklama: "Foto oder Röntgenbild hochladen. Verifizierte Kliniken senden in 2-4 Stunden Angebote.", detaylar: ["Völlig kostenlos", "Antwort in 2-4 Stunden", "Von mehreren Kliniken"] },
        { foto: "https://images.unsplash.com/photo-1434626881859-194d67b2b86f?w=600&h=400&fit=crop", baslik: "Angebote vergleichen", aciklama: "Preis, Inhalt und Klinikprofile nebeneinander prüfen. Das Beste ohne Druck wählen.", detaylar: ["Nebeneinander Vergleich", "Verifizierte Bewertungen", "Transparente Preise"] },
        { foto: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&h=400&fit=crop", baslik: "Hotel & Transfer wählen", aciklama: "Partnerhotels in Kliniknähe durchsuchen. Flughafentransfer integriert planen.", detaylar: ["Hotels in Kliniknähe", "Flughafentransfer", "Paketpreisvorteil"] },
        { foto: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&h=400&fit=crop", baslik: "Sicher bezahlen", aciklama: "Ihre Zahlung wartet auf unserem sicheren Konto bis Behandlung abgeschlossen ist.", detaylar: ["Treuhandzahlungssystem", "Keine Zahlung ohne Genehmigung", "Schutz vor Zusatzeingriffen"] },
        { foto: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=600&h=400&fit=crop", baslik: "Erfahrung teilen", aciklama: "Bewertung nach der Behandlung schreiben. Anderen Patienten helfen.", detaylar: ["Verifizierte Bewertungen", "Bewertungssystem", "Anderen Patienten helfen"] },
      ],
      sorular: [
        { soru: "Ist Medoqa kostenlos?", cevap: "Ja! Medoqa ist für Patienten völlig kostenlos." },
        { soru: "Wie werden Kliniken verifiziert?", cevap: "Alle Kliniken reichen Lizenzen, Arztzertifikate und Versicherungsdokumente ein. Ohne Admin-Genehmigung nicht aktiv." },
        ...
        { soru: "Muss ich für Zusatzeingriffe extra bezahlen?", cevap: "Nein! Die Klinik muss Ihre Genehmigung einholen. Ohne Genehmigung nichts." },
        { soru: "Welche Länder bedienen Sie?", cevap: "Medoqa ist eine globale Plattform mit Kliniken für Patienten aus aller Welt." },
        { soru: "Gibt es Sprachunterstützung?", cevap: "Ja! Türkisch, Englisch und Deutsch. Weitere Sprachen kommen bald." },
      ],
    },
  };
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f8f9ff", fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      <section style={{ maxWidth: "1200px", margin: "0 auto", padding: mobil ? "32px 16px" : "80px 32px" }}>
        <h2 style={{ fontSize: mobil ? "22px" : "32px", fontWeight: 800, color: "#0f0d2e", textAlign: "center", marginBottom: mobil ? "28px" : "56px", letterSpacing: "-0.5px" }}>{ic.adimlarBaslik}</h2>
        <div style={{ display: "flex", flexDirection: "column", gap: mobil ? "16px" : "24px" }}>
          {ic.adimlar.map((adim, i) => (
            <div key={i} style={{
              background: "#fff",
              borderRadius: mobil ? "16px" : "20px",
              overflow: "hidden",
              border: "1px solid #eeecff",
              display: "grid",
              gridTemplateColumns: mobil ? "1fr" : (i % 2 === 0 ? "320px 1fr" : "1fr 320px"),
            }}>
              {mobil ? (
                // Mobil: foto üstte, numara üst sağda
                <>
                  <div style={{ position: "relative", height: "180px", overflow: "hidden" }}>
                    <img src={adim.foto} alt={adim.baslik} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    <div style={{ position: "absolute", top: "12px", left: "12px", background: "#534AB7", color: "#fff", fontSize: "13px", fontWeight: 800, width: "32px", height: "32px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  ...
                  <div style={{ padding: "20px" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                      {adim.detaylar.map(d => (
                        <div key={d} style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "12px", color: "#534AB7", fontWeight: 500 }}>
                          <div style={{ width: "16px", height: "16px", borderRadius: "50%", background: "#534AB715", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "9px", flexShrink: 0 }}>✓</div>
                          {d}
                        </div>
                      ))}
                    </div>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                      {adim.detaylar.map(d => (
                        <div key={d} style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "13px", color: "#534AB7", fontWeight: 500 }}>
                          <div style={{ width: "18px", height: "18px", borderRadius: "50%", background: "#534AB715", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "10px", flexShrink: 0 }}>✓</div>
                          {d}
                        </div>
                      ))}
                    </div>
