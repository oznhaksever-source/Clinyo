...
const tumTransferler = [
  { id: "1", kisaltma: "VT", ad: "VIP Transfer Istanbul", sehir: "Istanbul", puan: 4.9, yorum: 324, fiyat: 35, para: "EUR", araclar: ["Sedan", "Van", "VIP Minibus"], diller: ["TR", "EN", "DE"], sure: "30-60 dk", musaitlik: "7/24", ozellikler: ["Karsilama Tabelasi", "Ucus Takibi", "Ucretsiz Bekleme", "WiFi"] },
  { id: "2", kisaltma: "AT", ad: "Ankara Airport Transfer", sehir: "Ankara", puan: 4.7, yorum: 189, fiyat: 25, para: "EUR", araclar: ["Sedan", "Van"], diller: ["TR", "EN"], sure: "20-40 dk", musaitlik: "7/24", ozellikler: ["Karsilama Tabelasi", "Ucus Takibi", "Ucretsiz Bekleme"] },
  { id: "3", kisaltma: "LT", ad: "Luxury Transfer Co.", sehir: "Istanbul", puan: 4.8, yorum: 256, fiyat: 55, para: "EUR", araclar: ["VIP Sedan", "VIP Van", "Limuzin"], diller: ["TR", "EN", "DE"], sure: "30-60 dk", musaitlik: "7/24", ozellikler: ["Karsilama Tabelasi", "Ucus Takibi", "Ucretsiz Bekleme", "WiFi", "Icecek Ikrami"] },
  { id: "4", kisaltma: "IT", ad: "Izmir Transfer", sehir: "Izmir", puan: 4.6, yorum: 134, fiyat: 20, para: "EUR", araclar: ["Sedan", "Van"], diller: ["TR", "EN"], sure: "20-35 dk", musaitlik: "7/24", ozellikler: ["Karsilama Tabelasi", "Ucretsiz Bekleme"] },
  { id: "5", kisaltma: "BT", ad: "Bursa Transfer", sehir: "Bursa", puan: 4.5, yorum: 98, fiyat: 22, para: "EUR", araclar: ["Sedan", "Van"], diller: ["TR", "EN"], sure: "25-40 dk", musaitlik: "7/24", ozellikler: ["Karsilama Tabelasi", "Ucus Takibi"] },
];

const sehirler = ["Istanbul", "Ankara", "Izmir", "Bursa", "Antalya"];
const aracTipleri = ["Sedan", "Van", "VIP Sedan", "VIP Van", "Limuzin", "VIP Minibus"];
...
export default function Transfer() {
  ...
  const filtreliTransferler = tumTransferler
    .filter((t) => {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f9fafb", fontFamily: "sans-serif" }}>
      ...
      <section style={{ background: "linear-gradient(135deg, #12103a 0%, #1e1b4b 100%)", padding: "40px 32px" }}>
        ...
        <p style={{ color: "#8b8fc8", fontSize: "15px", marginBottom: "24px" }}>Havalimanından kliniğe, kliniğe otele guvenli ve konforlu transfer</p>
        <div style={{ background: "#fff", borderRadius: "12px", padding: "8px", display: "flex", gap: "8px", maxWidth: "600px" }}>
          <input type="text" placeholder="Sehir veya transfer firmasi ara..." value={aramaMetni} onChange={(e) => setAramaMetni(e.target.value)} style={{ flex: 1, border: "none", outline: "none", padding: "10px 14px", fontSize: "14px", background: "transparent" }} />
      ...
      <section style={{ background: "#fff", borderBottom: "1px solid #EEEDFE", padding: "20px 32px" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px" }}>
          {[
            { ikon: "✈️", baslik: "Havalimani Karsilama", aciklama: "Ucusunuzu takip ediyoruz" },
            { ikon: "🏥", baslik: "Klinik Transferi", aciklama: "Klinige guvenle ulasin" },
            { ikon: "🏨", baslik: "Otel Transferi", aciklama: "Otele konforla gidin" },
            { ikon: "🚗", baslik: "Sehir Ici Transfer", aciklama: "Istediginiz yere ulasin" },
          ].map((item) => (
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "32px", display: "grid", gridTemplateColumns: "280px 1fr", gap: "24px" }}>
        ...
        <div>
          ...
          <div style={{ background: "#fff", border: "1px solid #EEEDFE", borderRadius: "12px", padding: "20px" }}>
            <h3 style={{ fontSize: "13px", fontWeight: 700, color: "#12103a", marginBottom: "12px", textTransform: "uppercase", letterSpacing: "0.5px" }}>Arac Tipi</h3>
            {aracTipleri.map((a) => (
        ...
        <div>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
            <span style={{ fontSize: "14px", color: "#888" }}><strong style={{ color: "#12103a" }}>{filtreliTransferler.length}</strong> transfer firmasi bulundu</span>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                ...
                <div style={{ flex: 1, padding: "18px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }}>
                    <div>
                      ...
                      <div style={{ fontSize: "12px", color: "#888", marginBottom: "6px" }}>{t.sehir} — Sure: {t.sure}</div>
                    ...
                    <div style={{ textAlign: "right" }}>
                      ...
                      <div style={{ fontSize: "11px", color: "#888" }}>tek yon</div>
                    </div>
                  </div>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
                      {t.ozellikler.map((o) => (
                        <span key={o} style={{ fontSize: "11px", color: "#0a7a3a" }}>✓ {o}</span>
                      ))}
                    </div>
            ...
            {filtreliTransferler.length === 0 && (
              <div style={{ textAlign: "center", padding: "64px", background: "#fff", borderRadius: "14px", border: "1px solid #EEEDFE" }}>
                ...
                <div style={{ fontSize: "16px", fontWeight: 700, color: "#12103a", marginBottom: "8px" }}>Transfer bulunamadi</div>
