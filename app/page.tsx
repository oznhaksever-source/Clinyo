...
export default function AnaSayfa() {
  ...
  const icerik = {
    tr: {
      ...
      heroAlt: "Dünyanın dört bir yanından onaylı klinikler, şeffaf fiyatlar ve Medoqa güvencesiyle sağlık turizminizi planlayın.",
      teklifAl: "Ücretsiz Teklif Al",
      klinikleriKesf: "Klinikleri Keşfet",
      guvenBadge1: "✓ Onaylı Klinikler",
      guvenBadge2: "⚖ Şeffaf Fiyat",
      guvenBadge3: "🛡 Onaylı Klinik Güvencesi",
      ...
      farklar: [
        ...
        { ikon: "Lock", renk: "#4F46E5", baslik: "Onaylı Klinik Güvencesi", aciklama: "Platformumuzdaki her klinik Sağlık Bakanlığı belgelerini sunmuş ve admin incelemesinden geçmiştir. Sorun yaşarsanız Medoqa ekibi ulaşılabilir." },
      ...
      adimlar: [
        ...
        { no: "03", baslik: "Güvenle Gelin", aciklama: "Otel ve transferi planlayın. Seçtiğiniz klinikle doğrudan iletişime geçin. Medoqa tüm süreçte yanınızda." },
      ],
    ...
    en: {
      ...
      heroAlt: "Verified clinics from around the world, transparent prices and the Medoqa guarantee. Plan your health journey with confidence.",
      teklifAl: "Get Free Quote",
      klinikleriKesf: "Explore Clinics",
      guvenBadge1: "✓ Verified Clinics",
      guvenBadge2: "⚖ Transparent Pricing",
      guvenBadge3: "🛡 Verified Clinic Assurance",
      ...
      farklar: [
        ...
        { ikon: "Lock", renk: "#4F46E5", baslik: "Verified Clinic Assurance", aciklama: "Every clinic on our platform has submitted Ministry of Health documents and passed admin review. Our team is reachable if you need support." },
      ...
      adimlar: [
        ...
        { no: "03", baslik: "Come with Confidence", aciklama: "Plan hotel and transfer. Connect directly with your chosen clinic. Medoqa is by your side throughout." },
      ],
    ...
    de: {
      ...
      heroAlt: "Verifizierte Kliniken aus aller Welt, transparente Preise und geprüfte Kliniken. Planen Sie Ihre Gesundheitsreise mit Vertrauen.",
      teklifAl: "Kostenloses Angebot",
      klinikleriKesf: "Kliniken entdecken",
      guvenBadge1: "✓ Verifizierte Kliniken",
      guvenBadge2: "⚖ Transparente Preise",
      guvenBadge3: "🛡 Geprüfte Klinik-Garantie",
      ...
      farklar: [
        ...
        { ikon: "Lock", renk: "#4F46E5", baslik: "Geprüfte Klinik-Sicherheit", aciklama: "Jede Klinik hat Dokumente des Gesundheitsministeriums eingereicht und eine Admin-Prüfung durchlaufen. Unser Team ist bei Bedarf erreichbar." },
      ...
      adimlar: [
        ...
        { no: "03", baslik: "Mit Vertrauen kommen", aciklama: "Hotel und Transfer planen. Direkt mit Ihrer Klinik kommunizieren. Medoqa begleitet Sie durchgehend." },
      ],
    ...
    ar: {
      ...
      heroAlt: "عيادات معتمدة من جميع أنحاء العالم، أسعار شفافة وضمان Medoqa. خططي لرحلتك الصحية بثقة.",
      teklifAl: "احصل على عرض مجاني",
      klinikleriKesf: "استكشف العيادات",
      guvenBadge1: "✓ عيادات معتمدة",
      guvenBadge2: "⚖ أسعار شفافة",
      guvenBadge3: "🛡 ضمان العيادة المعتمدة",
      ...
      farklar: [
        ...
        { ikon: "Lock", renk: "#4F46E5", baslik: "ضمان العيادة المعتمدة", aciklama: "كل عيادة في منصتنا قدمت وثائق وزارة الصحة واجتازت مراجعة الإدارة. فريقنا متاح إذا احتجت للدعم." },
      ...
      adimlar: [
        ...
        { no: "03", baslik: "تعال بثقة", aciklama: "خطط للفندق والنقل. تواصل مباشرة مع عيادتك. Medoqa بجانبك في كل خطوة." },
      ],
    ...
    ru: {
      ...
      heroAlt: "Сертифицированные клиники со всего мира, прозрачные цены и гарантия Medoqa. Планируйте медицинское путешествие с уверенностью.",
      teklifAl: "Получить бесплатное предложение",
      klinikleriKesf: "Найти клиники",
      guvenBadge1: "✓ Проверенные клиники",
      guvenBadge2: "⚖ Прозрачные цены",
      guvenBadge3: "🛡 Гарантия проверенных клиник",
      ...
      farklar: [
        ...
        { ikon: "Lock", renk: "#4F46E5", baslik: "Гарантия проверенных клиник", aciklama: "Каждая клиника на платформе предоставила документы Министерства здравоохранения и прошла проверку администратора. Наша команда доступна при необходимости." },
      ...
      adimlar: [
        ...
        { no: "03", baslik: "Приезжайте с уверенностью", aciklama: "Организуйте отель и трансфер. Общайтесь напрямую с клиникой. Medoqa сопровождает вас на каждом шагу." },
      ],
    ...
    fr: {
      ...
      heroAlt: "Cliniques vérifiées du monde entier, prix transparents et des cliniques vérifiées. Planifiez votre parcours de santé en toute confiance.",
      teklifAl: "Obtenir un devis gratuit",
      klinikleriKesf: "Explorer les cliniques",
      guvenBadge1: "✓ Cliniques vérifiées",
      guvenBadge2: "⚖ Prix transparents",
      guvenBadge3: "🛡 Assurance cliniques vérifiées",
      ...
      farklar: [
        ...
        { ikon: "Lock", renk: "#4F46E5", baslik: "Assurance cliniques vérifiées", aciklama: "Chaque clinique a soumis des documents du Ministère de la Santé et passé une revue admin. Notre équipe est joignable si vous avez besoin d'aide." },
      ...
      adimlar: [
        ...
        { no: "03", baslik: "Venez en toute confiance", aciklama: "Planifiez hôtel et transfert. Communiquez directement avec votre clinique. Medoqa vous accompagne tout au long." },
      ],
