...
export default function Blog() {
  ...
  const icerik = {
    ...
    ar: { baslik: "المدونة", altBaslik: "أحدث المعلومات والأدلة حول السياحة الصحية", yaklindaBaslik: "مقالات المدونة قريباً", yaklindaAciklama: "محتوى مفيد حول السياحة الصحية وأدلة العلاج وتجارب المرضى سيكون هنا قريباً.", kategoriler: ["علاج الأسنان", "زراعة الشعر", "جراحة العيون", "تجارب المرضى", "دليل السفر"] },
    ru: { baslik: "Блог", altBaslik: "Актуальная информация и руководства о медицинском туризме", yaklindaBaslik: "Статьи блога скоро появятся", yaklindaAciklama: "Полезный контент о медицинском туризме, руководства по лечению и опыт пациентов скоро будут здесь.", kategoriler: ["Стоматология", "Пересадка волос", "Операция на глазах", "Опыт пациентов", "Путеводитель"] },
    fr: { baslik: "Blog", altBaslik: "Dernières informations et guides sur le tourisme médical", yaklindaBaslik: "Articles de blog bientôt disponibles", yaklindaAciklama: "Du contenu utile sur le tourisme médical, des guides de traitement et des expériences de patients seront bientôt disponibles.", kategoriler: ["Soins dentaires", "Greffe de cheveux", "Chirurgie oculaire", "Expériences patients", "Guide de voyage"] },
  };
